App = {
  ...
  initWeb3: async function() {
    ...
    console.log('initWeb3')
      ...
      // Legacy dapp browsers...
        ...
        console.log('initWeb3 with web3')
  ...
  initContract: function() {
      ...
      $.getJSON('Adoption.json', function(data) {
        console.log('initContract Adoption json ', data)
  ...
  unadoptAll: function() {
    App.contracts.Adoption.deployed().then(function(instance) {
        ...
        return adoptionInstance.unadoptAll(1, {from: App.web3Provider.selectedAddress });
      }).then(function(adopters) {
        console.log('adopters empty', adopters)
      }).catch(function(err) {
  ...
  markAdopted: function(adopters, account) {
      ...
      App.contracts.Adoption.deployed().then(function(instance) {
        ...
        console.log('mark adopted adopters 2', adopters)
  ...
  handleAdopt: function(event) {
    ...
    web3.eth.getAccounts(function(error, accounts) {
      ...
      console.log('handle Adopt account is', account)
